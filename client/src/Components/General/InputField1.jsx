...
export default function InputField1({
    ...
    return (
        <div key={field.name} className={`w-full ${className}`}>
            <div
                className={`z-[1] ml-2 px-[5px] w-fit relative top-[10px] text-[15px] font-medium ${
                    isDarkMode
            ...
            <div className="relative w-full">
                <input
                    ...
                    className={`overflow-x-scroll shadow-sm py-2 rounded-md px-3 w-full border-[0.01rem] placeholder:text-[15px] ${
                        isDarkMode
                ...
                {passwordVariants.includes(field.name) && (
                    <div
                        ...
                        className={`size-[16px] absolute right-0 top-[50%] transform translate-y-[-50%] mr-4 cursor-pointer ${
